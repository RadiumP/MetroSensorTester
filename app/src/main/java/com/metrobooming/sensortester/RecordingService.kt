...
class RecordingService : Service() {
    companion object {
        ...
        val headers = listOf(
            ...
            "accel_world_east_mean", "accel_world_north_mean", "accel_world_up_mean",
            "accel_world_samples",
            ...
            "magnet_magnitude_jitter", "magnet_jitter_smoothed",
            "magnet_candidate_state", "magnet_assist_note",
            "magnet_calibration_status",
            "magnet_calibration_low_jitter", "magnet_calibration_high_jitter",
            ...
            "compass_active", "compass_source",
            "compass_magnetic_azimuth_deg", "compass_true_azimuth_deg",
    ...
    private val tick = object : Runnable {
        override fun run() {
            ...
            val row = listOf(
                ...
                sensor.gravityX, sensor.gravityY, sensor.gravityZ,
                sensor.accelWorldEastMean, sensor.accelWorldNorthMean,
                sensor.accelWorldUpMean, sensor.accelWorldSamples,
                ...
                inferred.magnetJitterSmoothed,
                inferred.magnetCandidateState ?: "",
                inferred.magnetAssistNote,
                inferred.magnetCalibrationStatus,
                inferred.magnetCalibrationLowJitter,
                inferred.magnetCalibrationHighJitter,
                inferred.magnetStopCandidateElapsedMs,
                inferred.magnetMovingCandidateElapsedMs,
                ...
                inferred.fusionLockoutRemainingMs,
                if (inferred.fusionStopReferenceReady) 1 else 0,
                inferred.fusionStopReferenceMagnet,
                ...
                if (sensor.compassActive) 1 else 0,
                sensor.compassSource,
                sensor.compassMagneticAzimuthDeg,
                sensor.compassTrueAzimuthDeg,
                sensor.compassHeadingDeg,
                sensor.compassDirection,
                sensor.compassReference,
                sensor.compassAccuracy,
                sensor.compassAccuracyLabel,
                sensor.compassCalibration,
